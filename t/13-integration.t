...
# all the ngx.sleep needed to synchronize the events. Running them individually
...
=== TEST 2: ensure counters work properly F
--- http_config eval
qq{
    $::HttpConfig
}
...
=== TEST 3: ensure counters work properly T
--- http_config eval
qq{
    $::HttpConfig
}
...
=== TEST 4: ensure counters work properly O
--- http_config eval
qq{
    $::HttpConfig
}
